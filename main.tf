...
module "backend" {
  ...
  parameters          = ["arn:aws:ssm:us-east-1:367241114876:parameter/${var.env}.${var.project_name}.rds.*","arn:aws:ssm:us-east-1:367241114876:parameter/newrelic.*", "arn:aws:ssm:us-east-1:367241114876:parameter/artifactory.*"  ]
  kms                 = var.kms_key_id
...
module "frontend" {
  ...
  parameters          = ["arn:aws:ssm:us-east-1:367241114876:parameter/newrelic.*", "arn:aws:ssm:us-east-1:367241114876:parameter/artifactory.*"]
  kms                 = var.kms_key_id
  prometheus_cidrs    = var.prometheus_cidrs
}
